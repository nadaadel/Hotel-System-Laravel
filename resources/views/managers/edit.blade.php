...
<div class="card-body">
                    <form method="POST" action="/managers/{{$manager->id}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text"  name="name" value= {{$manager->name}} >
                                @if ($errors->has('name'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input id="email" name="email" type="text" value= {{$manager->email}} >
                            @if ($errors->has('email'))
                                    <span class="alert alert-danger">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input id="national_id" name="national_id" type="text" value= {{$manager->national_id}} >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                            <input id="password" name="password" type="password" value= {{$manager->password}} >
